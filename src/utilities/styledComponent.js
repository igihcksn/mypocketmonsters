...
export const MobileNavButton = styled.button`
  ...
  background-color: ${(props) => (props.active ? "#e45b04" : "#af4417")};
  margin: 10px;
...
export const PokeButtonBackHeader = styled.div`
  ...
  @media (max-width: 420px) {
    display: ${(props) => (props.isList ? "inline-block" : "none")};
  }
`;
...
export const PokeHeaderImgContainer = styled.div`
  ...
  @media (max-width: 420px) {
    flex-direction: column;
    display: ${(props) => (props.isList ? "none" : "flex")};
    min-heigh: ${(props) => (props.isList ? "30vh" : "10vh")};
  }
`;
...
export const PokeDetailsAbilitiesMoves = styled.span`
  margin: ${(props) => (props.type === "move" ? "2px 0px" : 0)};
  color: #ffffff;
  font-weight: 600;
  background-color: #19072d;
  border: 1px solid #19072d;
